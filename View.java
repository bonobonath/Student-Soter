...
public class View extends JFrame implements ActionListener {
   ...
   public static final int FRAME_WIDTH = 500;
     ...
     *         Call getMain().search(lastName) and pass the retur Student.setCurrStudent()
    ...
    public void actionPerformed(ActionEvent pEvent) {
    	if (pEvent.getSource() == mSearchButton) {
    		...
    		if (lastName.length() == 0) {
    			...
    			if (Student.getCurrStudent() != null) saveStudent(Student.getCurrStudent());
    ...
    private void clearNumbers () {
    	for (int i = 0; i < Main.getNumExams(); ++i) mExamText[i].setText("");
    	for (int i = 0; i < Main.getNumHomeworks(); ++i) mHomeworkText[i].setText("");
    }
